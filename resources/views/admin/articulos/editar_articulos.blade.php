...
@section('contenido')
    <div id="articulos" style="">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="was-validated" action="{{ route('articulos.update', $articulo->id) }}" method="POST">
                    @csrf
                    <input name="_method" type="hidden" value="PUT">
                    <div class="col-12 form-group">
                        <label for="titulo">Título<span class="text-danger">*</span></label>
                        <input class="form-control{{ $errors->has('titulo') ? ' is-invalid' : '' }}" id="titulo"
                               name="titulo" type="text" placeholder="Ingresar el título" minlength="3"
                               value="{{ $articulo->titulo }}" required autofocus>
                    ...
                    <div class="col-12 mb-3">
                        <select class="custom-select form-control-sm" id="categoria" name="categoria" required>
                    ...
                    <div class="col-12 mb-3">
                        <textarea id="articulo" name="articulo"
                                  ...
                                  placeholder="Escriba el contenido">{{ $articulo->contenido }}</textarea>
                           ...
                           <span class="input-group-btn">
                            ...
                            @if($articulo->imagenes->count())
                                <input
                                    ...
                                    id="img-entrada" value="{{ $articulo->imagenes[0]->url_imagen }}"
                                    type="text" name="img-entrada">
                            @else
                                <input
                                    class="form-control form-control-sm{{ $errors->has('img-entrada') ? ' is-invalid' : '' }}"
                                    id="img-entrada" type="text" name="img-entrada">
                            @endif
                            <div class="invalid-feedback">
                                {{--@if ($errors->has('img-entrada'))--}}
                                <div class="alert-danger" role="alert">
                                    <strong>
...
@section('script-vue')
    ...
    <script>
        let articulo = @json($articulo);
        window.onload = function cargar() {
            if (articulo.publicar)
