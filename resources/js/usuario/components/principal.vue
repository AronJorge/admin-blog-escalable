        ...
        <b-collapse class="mt-2" v-model="showCollapse" id="collapse4">
            <div class="card">
                <div class="card-header">
                    <b>{{ bottomForm? 'Actualizar':'Crear'}} usuario</b>
                </div>
                        ...
                        <div class="row">
                            <b-col cols="12" md="6">
                                <b-input-group size="sm" class="mb-3"
                                               prepend="Nombres<span class='text-danger'>*</span>">
                                    <b-form-input v-model="form.nombres" type="text" placeholder="Ingresar nombres"
                                                  :state="nameState">
                                    </b-form-input>
                            ...
                            <b-col cols="12" md="6">
                                <b-input-group size="sm" class="mb-3"
                                               prepend="Apellidos<span class='text-danger'>*</span>">
                                    <b-form-input v-model="form.apellidos" type="text"
                            ...
                            <b-col cols="12" md="6">
                                <b-input-group size="sm" class="mb-3"
                                               prepend="Correo<span class='text-danger'>*</span>">
                                    <b-form-input v-model="form.correo" type="email"
                            ...
                            <b-col cols="12" md="6">
                                <b-form-select v-model="form.rol" :options="JSON.parse(roles)" text-field="nombre"
                                               value-field="id" class="mb-3" size="sm" :state="rolState"/>
                            </b-col>
                    ...
                    <b-container fluid>
                        ...
                        <b-table show-empty
                            ...
                            <template slot="roles" slot-scope="row">
                                {{ row.item.roles.length > 0 ? row.item.roles[0].nombre: '' }}
                            </template>
                            <template slot="roles" slot-scope="row">
                                {{ row.item.roles.length > 0 ? row.item.roles[0].nombre: '' }}
                            </template>
                            ...
                            <template slot="email_verified_at" slot-scope="row">
                                <span v-if="row.value == null" class="btn-brand btn-sm btn-youtube">
                                    <i class="far fa-envelope"></i><span><i class="fas fa-user-times"></i></span></span>
                                <span v-else class="btn-brand btn-sm btn-spotify">
                                    <i class="far fa-envelope"></i><span><i class="fas fa-user-check"></i></span></span>
                            </template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                fields: [
                    ...
                    {key: 'last_name', label: 'Apellidos', sortable: true, class: 'text-nowrap'},
        ...
        methods: {
            ...
            onSubmit(evt) {
                ...
                axios.post(`/admin/usuarios`, this.form).then(res => {
            ...
            onUpdate(evt) {
                ...
                axios.put(`/admin/usuarios/${this.form.id}`, this.form).then(res => {
            ...
            onDelete(item) {
                axios.delete(`/admin/usuarios/${item.id}`).then(res => {
